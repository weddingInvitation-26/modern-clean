document.addEventListener('DOMContentLoaded', () => {
  ...
  if (typeof particlesJS !== 'undefined') {
    particlesJS('particles-js', {
      particles: {
        ...
        line_linked: { enable: true, distance: 150, color: '#4A6CF7', opacity: 0.08, width: 1 },
  ...
  (function createPetals() {
    ...
    for (let i = 0; i < petalCount; i++) {
      ...
      petal.style.background = ['#4A6CF7', '#7B9CFF', '#6C63FF', '#5A52E0', '#1A1A2E'][Math.floor(Math.random() * 5)];
  ...
  const gradients = [
    'linear-gradient(135deg, #4A6CF7, #7B9CFF)',
    'linear-gradient(135deg, #6C63FF, #4A6CF7)',
    'linear-gradient(135deg, #5A52E0, #6C63FF)',
    'linear-gradient(135deg, #7B9CFF, #FFFFFF)',
    'linear-gradient(135deg, #4A6CF7, #1A1A2E)',
